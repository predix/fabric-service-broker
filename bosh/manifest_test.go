...
var boshDetails = bosh.NewDetails(boshStemcell, boshUuid, vmType, networkNames, directorUrl)

func TestNewManifest(t *testing.T) {
	manifest, err := bosh.NewManifest(deploymentName, networkName, boshDetails)
